    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/vent-soft/client/**", "/api/vent-soft/invoice/**", "/api/vent-soft/city/**").hasAnyRole("ADMIN", "USER")
                        .requestMatchers("/api/vent-soft/**").hasRole("ADMIN")
                        .requestMatchers("/vent-soft/**").authenticated()
